...
@class NSArray, NSDictionary, NSMutableArray, NSString, NSTimer, SBActivationInfoViewController, SBBuddyRegulatoryInfoViewController, SBLockScreenViewController;
