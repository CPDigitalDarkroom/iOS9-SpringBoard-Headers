...
@class BBDataProviderConnection, NSDate, NSHashTable, NSMutableArray, NSMutableSet, NSNumberFormatter, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSSet, NSString, NSTimer, SBAppStatusBarSettingsAssertion, SBApplication, SBCardItemsController, SBPowerDownController, SBSStatusBarStyleOverridesAssertion, SBUIController, UIWindow;
