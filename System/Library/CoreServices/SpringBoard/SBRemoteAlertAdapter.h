...
@property(nonatomic, getter=_remoteAlertAdapterDelegate, setter=_setRemoteAlertAdapterDelegate:) id <SBRemoteAlertAdapterDelegate> _remoteAlertAdapterDelegate; // @synthesize _remoteAlertAdapterDelegate;
