...
@property(readonly, retain, nonatomic) SBFolderIcon *targetIcon; // @dynamic targetIcon;
@property(readonly, retain, nonatomic) SBFolderIconView *targetIconView; // @dynamic targetIconView;
