...
@property(readonly, retain, nonatomic) NSArray *presentedAlertItems; // @synthesize presentedAlertItems=_presentedAlertItems;
...
@property(readonly, retain, nonatomic) SBAlertItem *currentAlertItem; // @synthesize currentAlertItem=_currentAlertItem;
