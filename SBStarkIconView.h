...
@property(nonatomic, getter=sb_isFocused) _Bool sb_focused; // @synthesize sb_focused=_sbFocused;
- (struct CGRect)_frameForLabel;
- (void)prepareForReuse;
- (id)_labelImageParameters;
- (void)sb_setIsFocused:(_Bool)arg1 animated:(_Bool)arg2;
- (void)sb_setIsFocused:(_Bool)arg1;
- (void)dealloc;
